...
3. После установки этих параметров, нужно обогатить нашу БД данными, чтобы проверить нагрузочное тестирование, выставил параметр 100, чтоб записей в основной таблице было х100 отностительно дефолтного значения(10000), т.е. создалось 1 млн записей в основной таблице. ![1.png](1.png)
4. Включил нагрузочное тестирование на 300 секунд, 100 пользователей и 8 потоков и получил следующий результат ![2.png](2.png)